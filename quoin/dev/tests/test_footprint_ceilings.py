...
CEILINGS = {
    ...
    "skill:pr": 21122,  # ratchet: the no-tool-attribution instruction (Step 4) grew the file past the prior 20850 B ceiling; retightened to the new measured size (measured 21122 B).
